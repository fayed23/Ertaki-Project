...
| File | Notes |
|---|---|
| `ertaki-android-release.apk` | Flutter **release** build **1.0.8+9**, **debug-signed** for sideload (not Play Store) |
| `ertaki-android-release.apk.sha1` | Content hash from Flutter build |

**GitHub Release:** [v1.0.8-apk](https://github.com/fayed23/Ertaki-Project/releases/tag/v1.0.8-apk)
